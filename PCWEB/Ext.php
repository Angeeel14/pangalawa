...
<head>
  ...
  <style>
        .message {
  max-width: 500px; /* Same width as the forms */
  ...
  margin-top: 70px; /* Add bottom margin */
}
...
.message a {
  color: #3b5d50; /* Link color consistent with other links */
...
<!-- End Header/Navigation -->
  ...
  <!-- Start Hero Section -->
  <div class="hero">
    <img src="../PCWEB/IMG/HERO.png" alt="Hero Background">
    <div class="container">
  ...
  <!-- End Hero Section -->
    ...
    <div class="message">
        <p>Account already Exist. Please choose another username.</p>
